...
from crslab.model.crs.mpkcr.CapsuleNet import CapsuleNet
from crslab.model.crs.mpkcr.CapsuleNet import CapsuleLayer
from crslab.model.crs.mpkcr.ContrastiveLoss import ContrastiveLoss
from crslab.model.crs.mpkcr.HyperGNN import HGNN
from crslab.model.crs.mpkcr.attention import MHItemAttention
...
from crslab.model.crs.mpkcr.decoder import TransformerDecoderKG


class MPKCRModel(BaseModel):
    """
    ...
    def __init__(self, opt, device, vocab, side_data):
        ...
        super(MPKCRModel, self).__init__(opt, device)
    ...
    def encode_user(self, batch_related_entities, batch_related_items, batch_context_entities, kg_embedding):
        ...
        for session_related_entities, session_related_items, context_entities in zip(batch_related_entities,
            ...
            if len(context_entities) == 0:
                user_repr = self._attention_and_gating(session_embedding, knowledge_embedding, None, caps_embedding)
            else:
